...
angular.module('starter.services', ['ngResource'])
  .constant("baseURL", "http://localhost:6001/api/")
  //.constant("baseURL", "http://soundthing1.mybluemix.net/api/")

  .factory('presetFactory', ['$resource', 'baseURL', function($resource, baseURL){
    return $resource(baseURL + "presets/:id", null, {
      'update': {
          method: 'PUT'
      }
    });
